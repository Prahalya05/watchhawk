...
import { llmStatus } from "../../llm/gemini.client";
import { COMMAND_HINT_LIST, runCommand } from "./command.service";
import { explainEvent } from "./explain.service";
...
assistantRouter.post("/command", asyncHandler(async (req, res) => {
...
assistantRouter.post("/explain", asyncHandler(async (req, res) => {
